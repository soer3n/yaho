...
func TestSetEnv(t *testing.T) {
	...
	for _, v := range getTestMainReleaseSpecs() {

		testObj := NewHelmClient(v.Input, &clientMock, &httpMock)
		...
		val, _ := v.ReturnValue.(cli.EnvSettings)
...
func getTestMainReleaseSpecs() []inttypes.TestCase {
