...
func GetChartMock() (*unstructuredmocks.K8SClientMock, *mocks.HTTPClientMock) {
	...
	// testcase 1
	repo := repositoryMock{Name: "foo", Namespace: "foo", IsPresent: true, Labels: map[string]string{"repo": "foo"}, URL: "https://foo.bar/charts"}

	charts := []chartMock{}
	versions := []chartVersionMock{}

	c := chartMock{Name: "bar", Namespace: "foo", Repository: "foo", IsPresent: true, Labels: map[string]string{"repo": "foo"}}
	cv := chartVersionMock{Chart: "bar", Version: "0.0.1", Namespace: "foo", IsPresent: true, URL: "https://foo.bar/charts/bar-0.0.1.tgz", Path: "../../../testutils/busybox-0.1.0.tgz"}
	...
	// testcase 2
	repo = repositoryMock{Name: "foo", Namespace: "two", IsPresent: true, Labels: map[string]string{"repo": "foo"}, URL: "https://foo.bar/charts"}

	charts = []chartMock{}
	versions = []chartVersionMock{}

	c = chartMock{Name: "baz", Namespace: "two", Repository: "foo", IsPresent: true, Labels: map[string]string{"repo": "foo"}}
	...
	// testcase 3
	repo = repositoryMock{Name: "foo", Namespace: "three", IsPresent: true, Labels: map[string]string{"repo": "foo"}, URL: "https://foo.bar/charts"}

	charts = []chartMock{}
	versions = []chartVersionMock{}

	c = chartMock{Name: "bar", Namespace: "three", Repository: "foo", IsPresent: false, Labels: map[string]string{"repo": "foo"}}
	...
	// testcase 4
	repo = repositoryMock{Name: "foo", Namespace: "four", IsPresent: true, Labels: map[string]string{"repo": "foo"}, URL: "https://foo.bar/charts"}

	charts = []chartMock{}
	versions = []chartVersionMock{}

	c = chartMock{Name: "foo", Namespace: "four", Repository: "foo", IsPresent: false, Labels: map[string]string{"repo": "foo"}}
	...
	// testcase 5
	repo = repositoryMock{Name: "bar", Namespace: "five", IsPresent: true, Auth: &credentialsMock{User: "foo", Password: "bar"}, Labels: map[string]string{"repo": "bar"}, URL: "https://bar.foo/charts"}

	charts = []chartMock{}
	versions = []chartVersionMock{}

	c = chartMock{Name: "foo", Namespace: "five", Repository: "bar", IsPresent: false, Labels: map[string]string{"repo": "bar"}}
...
func GetReleaseMock() (*unstructuredmocks.K8SClientMock, *mocks.HTTPClientMock) {
	...
	// general setup
	repo := repositoryMock{Name: "repo", Namespace: "foo", IsPresent: true, Labels: map[string]string{"repo": "foo"}, URL: "https://foo.bar/charts"}

	charts := []chartMock{}
	versions := []chartVersionMock{}

	c := chartMock{Name: "chart", Namespace: "foo", Repository: "repo", IsPresent: true, Labels: map[string]string{"repo": "foo"}}
...
func GetRepoMock() (*unstructuredmocks.K8SClientMock, *mocks.HTTPClientMock) {
	...
	// testcase 1
	repo := repositoryMock{Name: "foo", Namespace: "one", IsPresent: false, Labels: map[string]string{"repo": "foo"}, Auth: &credentialsMock{User: "foo", Password: "encrypted"}, URL: "https://foo.bar/charts"}

	charts := []chartMock{}
	versions := []chartVersionMock{}

	c := chartMock{Name: "foo", Namespace: "one", Repository: "foo", IsPresent: true, Labels: map[string]string{"repo": "foo"}}
	...
	// testcase 2
	repo = repositoryMock{Name: "bar", Namespace: "two", IsPresent: true, Labels: map[string]string{"repo": "bar"}, URL: "https://bar.foo/charts"}

	charts = []chartMock{}
	versions = []chartVersionMock{}

	c = chartMock{Name: "bar", Namespace: "two", Repository: "bar", IsPresent: true, Labels: map[string]string{"repo": "bar"}}
